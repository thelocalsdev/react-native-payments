            ...
            paymentToken:(NSString *_Nullable)token
{
    ...
    NSString *cloudpaymentsCryptogramPacket = [self convertToCloudpaymentsString:payment];
    [paymentResponse setObject:cloudpaymentsCryptogramPacket forKey:@"cloudpaymentsCryptogramPacket"];
...
// Convert PKPayment response to string for cloudpayments API ApplePay
- (NSString *) convertToCloudpaymentsString:(PKPayment *)payment {
